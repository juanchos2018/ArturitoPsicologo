...
public class AdapterLecturaDos extends RecyclerView.Adapter<AdapterLecturaDos.ViewHolderDatos> implements View.OnClickListener{

        ArrayList<Lectura> listaItems;
        Context context;

        public AdapterLecturaDos(ArrayList<Lectura> listaItems,Context context) {
        ...
        View vista= LayoutInflater.from(parent.getContext()).inflate( R.layout.item_lecura_dos,parent,false);
